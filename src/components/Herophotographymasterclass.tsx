// Herophotographymasterclass Component
        ...
        <div className="relative pt-20 pb-16 sm:pt-24 sm:pb-20 lg:pt-32 lg:pb-28">
          ...
          <div className="flex justify-center mb-8">
            <div className="inline-flex items-center px-4 py-2 bg-primary/10 border border-primary/20 rounded-full text-sm font-medium text-primary">
              ...
              New: Advanced Portrait & Landscape Modules
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed">
              Master the art of photography with Jake Wilson's comprehensive course. 
              Learn professional techniques, composition secrets, and post-processing skills to create stunning images.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-8 text-sm text-muted-foreground">
              ...
              <div className="flex items-center gap-1">
                ...
                <span className="ml-2">4.9/5 student rating</span>
              </div>
            </div>
          </div>
