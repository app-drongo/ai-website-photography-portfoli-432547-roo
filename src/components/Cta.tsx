...
export default function Cta() {
  const stats = [
    ...
    { value: "4.9/5", label: "Course Rating", icon: Shield },
    { value: "50+", label: "Video Lessons", icon: Zap },
    { value: "Lifetime", label: "Access", icon: Sparkles }
  ]
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join Jake Wilson's comprehensive Photography Masterclass and transform from beginner to pro. 
                Learn advanced techniques, composition secrets, and post-processing mastery.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Featured by leading photography publications
                </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Learn from award-winning photographer Jake Wilson
              </p>
            </div>
